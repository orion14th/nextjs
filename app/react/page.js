...
<h2 className="pageTitle">React<br />Playground</h2>  
</div>
...
Glad You Made It.</p>
     ...
     <Link href="./api-wordpress"> <Button variant="custom" className="min-w-44  bg-black text-white">WordrPresss Api</Button>
      ...
      <div className="container mx-auto  text-center"> <Link href="./api-external"> <Button variant="custom" className="min-w-44 bg-black text-white">Image Api</Button>
      </Link></div>
